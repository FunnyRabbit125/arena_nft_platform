...
function Header({ setWallet }) {
  ...
  <Container fluid>
      ...
      <Nav className="col-md-3 mx-auto">
      <Nav.Link href="https://twitter.com/ArenaRoyaleNFT" className="mt-5">
        <svg
              width="32"
              height="26"
              viewBox="0 0 32 26"
        ...
        <Nav.Item>
        <Nav.Link href="/">
          <img className="logo_wrapper"  src={require("../assets/img/area_royale_logo.png").default}
         alt="Logo"/>

          </Nav.Link>
       </Nav.Item>
        <Nav.Link href="https://discord.gg/5eTGqRxR" className="mt-5">
            <svg
              width="32"
              height="25"
              viewBox="0 0 32 25"
